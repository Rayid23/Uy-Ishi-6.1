        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/test" class="nav-link">Задачи</a>
                </li>
            </ul>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        if (auth()->role == "admin") { ?>
                            ...
                            <li class="nav-item <?= ($_SESSION['PanelActive'] <= 4 && $_SESSION['PanelActive'] >= 0) ? 'menu-open' : '' ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="AdminReports" class="nav-link <?= ($_SESSION['PanelActive'] == 4) ? 'active' : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Отчеты </p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item <?= ($_SESSION['PanelActive'] <= 8 && $_SESSION['PanelActive'] >= 6) ? 'menu-open' : '' ?>">
                                <a href="#" class="nav-link">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="AdminUserPage" class="nav-link <?= ($_SESSION['PanelActive'] == 6) ? 'active' : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Все пользователи</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="AdminNewUser" class="nav-link <?= ($_SESSION['PanelActive'] == 7) ? 'active' : '' ?>">
                                            <i class="far fa-circle nav-icon"></i>
                        ...
                        if (auth()->role == "admin") { ?>
                            ...
                            <li class="nav-item">
                                <a href="AdminDispetcher" class="nav-link">
                        ...
                        if (auth()->role == "user") { ?>
                            ...
                            <li class="nav-item">
                                <a href="userReceived" class="nav-link <?= ($_SESSION['PanelActive'] == 5) ? 'active' : '' ?>">
                                    <i class="nav-icon fas fa-columns"></i>
                                    <p>
                                        Входящие
                                    </p>
                        ...
                        <li class="nav-header">ЭТИКЕТКИ</li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <i class="nav-icon far fa-circle text-danger"></i>
                                <p class="text">Важный</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
